...
str(master)
```
# A litmus test to see what is happening

Data looks okay. Treatment effect is very evident. Potential treatment by year interaction...
...
```{r}
N_185_model_average <- lmer(N_total_kgha~Treatment*Stage+(1|Blk:Treatment), data = N_185_average)
