...
```{r}
model_2021 <- lmer(FNRE ~ NrateF*Treatment+(1|Treatment:Blk), data=FNRE_2021)
...
```{r}
model_2022 <- lmer(FNRE ~ NrateF*Treatment+(1|Treatment:Blk), data=FNRE_2022)
...
```{r}
model_2023 <- lmer(FNRE ~ NrateF*Treatment+(1|Treatment:Blk), data=FNRE_2023)
...
```{r}
model_average <- lmer(FNRE ~ NrateF*Treatment+(1|Treatment:Blk), data=FNRE_all)
...
ggsave(filename = "FNRE_combined.jpg",  # Include the file extension here
