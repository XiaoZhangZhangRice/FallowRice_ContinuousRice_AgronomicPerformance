...
```{r}
model_all <- lmer(N_total_kgha ~ NrateF*Treatment+(1|Treatment:Blk), data=Nrate_trial)
...
write_xlsx(all_means, "D:/Academics/UC Davis/School Work/Linquist Lab/Data/R stats/Agronomic paper/N uptake/N_uptake_maturity/0N_Nuptake_By_Year.xlsx")
```
