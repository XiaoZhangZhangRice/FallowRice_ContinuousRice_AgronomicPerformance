...
# Combining data into one nice excel file

```{r}
all_means_sd <- as.data.frame(rbind(yield_2021_dataframe, yield_2022_dataframe, yield_2023_dataframe))

write.xlsx(all_means_sd, file = "Zhang_yields_NrateTrials_2021to2023.xlsx", sheetName = "1", append = FALSE) #xlsx package
```
